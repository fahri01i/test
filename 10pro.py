...
import youtube_dl
#=============
cl = LineClient(authToken='EGBRJNFdY4rTHr3ms4Ke.ZihTRbq7Q53w6bcBupXkdG.CVxHBfEg25grItXBbYaBZxL6+Ino/GZG5j7jtZmcmUk=')
...
ki = LineClient(authToken='EGNSWADyBVH3wI8Npt3b.cvD22uetJjVQEqb8WglMMW.xi4WKnI7c5KMGO4edJMsq6r8FGCkvS9LToBRHN4na/g=')
...
kk = LineClient(authToken='EG7mcicebep3zuQEEDx0.zsgh7wSSYqUoRpwvp8BjGa.sAkWlJhTIBNyR7bjF7i04U8J5S3Hlr4FAoX97bcXGrg=')
...
kc = LineClient(authToken='EGbSmSpPZV6VMdqCVSu3.NzEK/3ObJj3S/CbfCm1gyW.VkG3APIGvVH7U2hI3Ml8eDxKbz7D+XC8h0qamwUnr3s=')
...
km = LineClient(authToken='EGNGozhZ12XbT5JCf0E6.RPmCP6LK67K+RE0P7bn45G.AMEZx7a/sUb3Zcq43Q6U7nNY1KmXh4L4um1hit8gB7E=')
...
kb = LineClient(authToken='EGGtPLNz7nwQceuQr1u9.8xGVefSqTRiTNa2y3ZMv2q.I0Y8BIELjUn6xMOcyJCZLr9xAMGR0mHfM1R8AjhcRHM=')
...
kn = LineClient(authToken='EGH3Hm3viJL3rHQClCbe.CtkuhofIUuirmrnqVEBfhG.crwuvULNJ1zlTdrjB21EXjvuyB3EwAIk6Ias51umimQ=')
...
ko = LineClient(authToken='EGTdELyHVMjgz76vxOnb.idtT6e8o+TlFO9S9OvlCMW.A007SX77Akw0v3enLomXg5rk0auXT6UeA2Sv9OAxFeY=')
...
kw = LineClient(authToken='EGUspAFtlhmyTe5Fhkf6.WjfyAqQ0fYkN6mjvVxekPG.UxEmKDBd3phaHGSry7SW8DXtWYRflMeR2ddIeOARHxQ=')
...
ke = LineClient(authToken='EGa4bKbdSBTaxwGXkwm5.J9M9Lqd4bNA1ZOAlABRCLq.dqAnA0OHBwkVi+on5lBrIunA9CwMWGBiI8BZDmbPsPU=')
...
ky = LineClient(authToken='EGvn3ia1hiES2AsW6oT1.nI1KHWANPL3Tu/vZoA2nSq.sPEshSptVJXEHZJYbCnFwVucd4HM324QMHpQsOHyw2g=')
...
sw = LineClient(authToken='EGu3TQQ9dA71dGP77yN6.eCCDKcIcQC3YyV2xLpUGjG.9+a+O2lP48w8j7syycxy9Ic8G7DuHxIBUYcER6MZzeE=')
...
creator = ["ucc81edac143bab9dd6e8109b50fc4a0e"]
owner = ["ucc81edac143bab9dd6e8109b50fc4a0e"]
admin = ["ucc81edac143bab9dd6e8109b50fc4a0e"]
staff = ["ucc81edac143bab9dd6e8109b50fc4a0e"]
mid = cl.getProfile().mid
Amid = ki.getProfile().mid
...
wait = {
    ...
    "limit":5,
    "unsend":False,
    "mention":"Lagi Stalking yaaa..! masuk sini..????",
    "Respontag":"Apaan tag2.....! penting VC aja langsung..!????????????",
    "welcome":"Welcome...",
    "leave":"Selamat jalan.. sampai berjumpa lagi dilain waktu????????????...",
    "comment":"Super Like ",
    "message":"makasih add nya.. cipok sini ???? ",
    }
                     ...
                     return
                        ...
                        if cmd == "selfbot on":
                          ...
                          if wait["selfbot"] == True:
                            ...
                            if msg._from in admin:
                                cl.sendText(msg.to,"「Created by :  kang abay") 
                                ma = ""
                                for i in creator:
                                    ma = cl.getContact(i)
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                            try:
                                ...
                                bot = runtime(eltime)
                                start = time.time()
                                sw.sendText("u05d2c283620ee70034667beb87619b8f")
                          ...
                          if msg._from in admin:
                            ...
                            try:
                                ...
                                kn.acceptGroupInvitationByTicket(group,Ticket)
                                ...
                                ky.acceptGroupInvitationByTicket(group,Ticket)
                                G.preventedJoinByTicket = True
                                cl.updateGroup(G)
                                try:
...
#===========BOT UPDATE============#
                          ...
                          if wait["selfbot"] == True:
                            if msg._from in admin:
                                sendMention(msg.to, sender, "「Aku datang beb」 ", "")
                                sendMention1(msg.to, sender, "「Aku temenin sayang」 ", "")
                                sendMention2(msg.to, sender, "「Njiiiir ke tiga gw」 ", "")
                                sendMention3(msg.to, sender, "「Assyik mojok beb」 ", "")
                                sendMention4(msg.to, sender, "「Hadir sayang ku, cinta ku」 ", "")
                                sendMention5(msg.to, sender, "「Gw mah cipok aja dah, muaaaach」 ", "")
                                sendMention6(msg.to, sender, "「Muaaaaaach juga」 ", "")
                                sendMention7(msg.to, sender, "「Muaaacccchh lagi」 ", "")
                                sendMention8(msg.to, sender, "「Cintaaaaaaaaaa」 ", "")
                                sendMention9(msg.to, sender, "「hadir」 ", "")
                                sendMention10(msg.to, sender, "「Njiiir barisan para mantan udah pada dateng」 ", "")
